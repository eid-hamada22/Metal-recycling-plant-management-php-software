...
<?php ob_start(); ?>
    <body id="body-pd">
            ...
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="advance.php" class="nav__link active">
        ...
        <h1 class="mstera">التسلايف</h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية تسليف جديدة</button></div>
                <div class="modal fade" id="name"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form method="post">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">اضافة عملية تسليف</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="float: right;">: الموظف</div>
                                    <div class="form-group">
                                    <select name="ac" id="" dir="rtl" placeholder="الموظف المعطى له " required class="form-control"   style="float: right;">
                                    <?php
                                            include 'includes/session.php';

                                            $sql1 = "SELECT * FROM muazafun  ORDER BY id ";
                ...
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    <thead>
                        <tr>
                          ...
                          <th style="width: 15%;"><center>الموظف</center></th>
                    ...
                    <?php
                              include 'includes/conn.php';
                                ...
                                $sql = "SELECT * FROM advance  WHERE date > '$farom'  ORDER BY id DESC";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        <td style=" text-align:center; width: 18%;">'.$row['employee'].'</td>
...
if (isset($_POST['add'])) {
    ...
    $sql ="INSERT INTO `advance`(`date`, `employee`, `amount`, `notes`) VALUES ('$datea','$ac','$amount','$notes')";

    $sql2 ="INSERT INTO `expenses`(`date`, `account`, `amount`, `notes`) VALUES ('$datea','تسليفات','$amount','$notes , سلفة ل $ac')";
