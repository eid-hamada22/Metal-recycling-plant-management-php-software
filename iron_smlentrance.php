...
<?php ob_start(); include 'includes/session.php';?>
    <body id="body-pd">
            ...
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="iron_smlentrance.php" class="nav__link active">
        ...
        <h1  class="mstera ds">مشتريات حديد صغيرة</h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;" class="ds"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية شراء جديدة</button></div>
                <center>
                    <form  method="post">
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">اضافة عملية شراء صغيرة</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" dir="rtl" placeholder="المبلغ المدفوع" required class="form-control" name="amount"  style="float: right;">
                                    </div>
                ...
                <div style="" class="ihra ds">:اخر العمليات</div>
                <table class="table table-hover tp">
                    ...
                    <?php
                              ...
                              if (isset($_GET['date'])) {
                                ...
                                $sql = "SELECT * FROM iron_smlentrance WHERE date LIKE '%$dt%' and date > '$farom' ORDER BY id  ";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    ...
                                    $datea = date("Y-m-d" , strtotime($row['date']));
                                        ...
                                        <td style=" text-align:center; width: 15%;">'.$row['amount'].'</td>
                                        <td style=" text-align:center; width: 15%;">'.$row['pricing'].'</td>
                ...
                <table class="table table-hover tp" style="">
                    ...
                    <td style="width: 30%; text-align:center;">كامل التسعير : <?php echo number_format($sadda23, 4, '.', ''); ?>  </td>
...
if (isset($_POST['add'])) {
    ...
    if($quantity > 30){$bg = 1;}else{$bg = 0;}
    $sql ="INSERT INTO `iron_smlentrance`(`date`, `quantity`, `pricing`, `amount`, `notes`) VALUES ('$datea','$quantity','$pricing','$amount','$notes')";

    $sql2 ="INSERT INTO `expenses`(`date`, `account`, `amount`, `notes`) VALUES ('$datea','شراء حديد','$amount','$notes , صرف شراء حديد')";

    if ($conn->query($sql) && $conn->query($sql2)) {

        header('location:iron_smlentrance.php ');
    }
    }
    if (isset($_POST['dt'])) {
        $dataas = $_POST['dataas'];
