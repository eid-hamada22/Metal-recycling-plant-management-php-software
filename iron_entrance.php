...
<?php ob_start(); ?>
    <body id="body-pd">
            ...
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="iron_entrance.php" class="nav__link active">
        ...
        <h1  class="mstera">مشتريات حديد كبيرة</h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"><button type="button" class="btn btn-primary btn-lg"" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية شراء جديدة</button></div>
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="float: right;">: الزبون</div>
                                    <div class="form-group">
                                    ...
                                    <div style="float: right;">: رقم الوزنة</div>
                                    <div class="form-group">
                                        <input type="number" dir="rtl" placeholder="رقم وزنة الميزان"  class="form-control" name="weight_nu"  style="float: right;">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="text" dir="rtl"placeholder="البيان" class="form-control" name="notes"  style="float: right;">
                                    </div>
                                </div>
                ...
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    <thead>
                        <tr>
                          ...
                          <th style="width: 20%;"><center>رقم الوزنة</center></th>
                          <th style="width: 20%;"><center>الكمية</center></th>
                          <th style="width: 20%;"><center>الزبون</center></th>
                    ...
                    <?php
                              include 'includes/conn.php';
                                $sql = "SELECT * FROM iron_entrance ORDER BY id DESC";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        <td style=" text-align:center; width: 20%;">'.$row['weight_nu'].'</td>
                                        <td style=" text-align:center; width: 20%;">'.$row['quantity'].'</td>
                                        <td style=" text-align:center; width: 20%;">'.$row['account'].'</td>
...
if (isset($_POST['add'])) {
    ...
    $date = $_POST['date'];
    $notes = $_POST['notes'];
    $weight_nu = $_POST['weight_nu'];
    $ac = $_POST['ac'];
    $datea = date("Y-m-d H:i:s" , strtotime($date));
    $sql ="INSERT INTO `iron_entrance`(`date`, `weight_nu`,`account`, `quantity`, `notes`) VALUES ('$datea','$weight_nu','$ac','$quantity','$notes')";

    if ($conn->query($sql)) { 
        header('location:iron_entrance.php ');
    }
    }
