...
<?php ob_start(); 
    ...
    if(!isset($_GET['id'])){
        ...
        $id = $_GET['id'];
        $sql = "SELECT * FROM customers WHERE name = '$id'";
...
?>
    <body id="body-pd">
        ...
        <h1 style="margin-left:700px ;  position: absolute;">حركات الزبون :<?php echo $row['name']; ?></h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
                <div style="float: right;position: absolute; margin-left:1100px ; margin-top: 100px; font-size: x-large">:الحركات</div>
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    <thead> 
                        <tr>
                          ...
                          <th style="width: 20%;"><center> الكمية الداخلة</center></th>
                          <th style="width: 20%;"><center>رقم الحركة</center></th>
                    ...
                    <?php
                              include 'includes/conn.php';
                                $sql = "SELECT * FROM  iron_entrance WHERE account = '$id' ORDER BY id DESC";
                                $result = mysqli_query($conn, $sql);
                                if(mysqli_num_rows($result)>0){
