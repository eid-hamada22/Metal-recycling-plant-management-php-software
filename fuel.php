...
<?php ob_start(); ?>
    <body id="body-pd">
            ...
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="fuel.php" class="nav__link active">
        ...
        <h1 class="mstera">تعبئة البنزين</h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية تعبئة جديدة</button></div>
                              ...
                              include 'includes/conn.php';
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        <td style=" text-align:center; width: 17%;">'.$row['quantity'].'</td>
...
if (isset($_POST['add'])) {
    ...
    $sql ="INSERT INTO `fuel`(`date`, `quantity`,`account`, `notes`) VALUES ('$datea','$quantity','$ac','$notes')";
