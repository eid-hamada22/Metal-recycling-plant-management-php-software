...
<?php ob_start();    include 'includes/session.php'; ?>
    ...
    <div class="l-navbar " id="navbar">
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="weights.php" class="nav__link active">
        ...
        <h1 class="mstera">مدخولات الميزان</h1>
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="float: right;">: الوزن</div>
                                    <div class="form-group">
                                        <input type="number" dir="rtl" placeholder="الوزن بالكيلو غرام"  class="form-control" name="quantity"  style="float: right;">
                                    </div>
                ...
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    <thead>
                        <tr>
                          ...
                          <th style="width: 15%;"><center> الوزن</center></th>
                    ...
                    <?php
                              include 'includes/conn.php';
                                $sql = "SELECT * FROM weights WHERE date > '$farom' ORDER BY id DESC ";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        <td style=" text-align:center; width: 15%;">'.$row['weight'].'</td>
...
if (isset($_POST['add'])) {
    ...
    $sql2 ="INSERT INTO `income`(`date`, `account`, `amount`, `notes`) VALUES ('$datea','مدخولات الميزان','$amount','$notes , دخل توزين')";
