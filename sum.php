                ...
                <table class="table table-hover tp" style="">
                    ...
                    <tbody id="output1" style="width: 100%;">
                            <?php
                              ...
                              $sql123578 = "SELECT SUM(amount) as amount FROM  income WHERE date > '$farom'  ";
                                $result123578 = mysqli_query($conn, $sql123578);
                                $row123578=mysqli_fetch_assoc($result123578);
                                $sadda2 = $row123578['amount'];
                            ...
                            $sql1235783 = "SELECT SUM(amount) as amount FROM  income WHERE account = 'مدخولات الميزان'  and date > '$farom'"; 
                                $result1235783 = mysqli_query($conn, $sql1235783);
                                $row1235783=mysqli_fetch_assoc($result1235783);
                                $sadda23 = $row1235783['amount'];
                                                                
                            $sql12357831 = "SELECT SUM(amount) as amount FROM  income WHERE account = 'تحويل رصيد'  and date > '$farom'"; 
                            ...
                            $sql1235784 = "SELECT SUM(quantity) as quantity FROM  iron_purchases WHERE date > '$farom' ";
                            ...
                            $sql1235785 = "SELECT SUM(quantity) as quantity FROM  iron_smlentrance WHERE date > '$farom' ";
                                $result1235785 = mysqli_query($conn, $sql1235785);
                                $row1235785=mysqli_fetch_assoc($result1235785);
                                $sadda25 = $row1235785['quantity'];

                                
                            $sql12357826 = "SELECT SUM(amount) as amount FROM  iron_smlentrance WHERE date > '$farom' ";
                                $result12357826 = mysqli_query($conn, $sql12357826);
                                $row12357826=mysqli_fetch_assoc($result12357826);
                                $sadda26 = $row12357826['amount'];
                            
                            $sql1235787 = "SELECT SUM(amount) as amount FROM  expenses WHERE account != 'شراء حديد' and  account != 'تسليفات ' and date > '$farom'  "; 
                            ...
                            $sql1235788 = "SELECT SUM(amount) as amount FROM  expenses WHERE account = 'تسليفات'  and date > '$farom'"; 
                                $result1235788 = mysqli_query($conn, $sql1235788);
                                $row1235788=mysqli_fetch_assoc($result1235788);
                                $sadda28 = $row1235788['amount'];
                                                                   
                            $sql1235789 = "SELECT SUM(amount) as amount FROM  expenses WHERE account = 'الرواتب'  and date > '$farom'"; 
                                $result1235789 = mysqli_query($conn, $sql1235789);
                                $row1235789=mysqli_fetch_assoc($result1235789);
                                $sadda29 = $row1235789['amount'];
                            
                            ?>
                         <tr>
                              <td style=" text-align:center;" >الرصيد المنقول عن الاسبوع السابق</td>
                              <td style=" text-align:center;" ><?php echo $sadda231 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"><?php echo $sadda231 ;?></td>
                              <td style=" text-align:center;"> رصيد منقول </td>
                              <td style=" text-align:center;">1 </td>
                        </tr>
                         <tr>
                              <td style=" text-align:center;" ></td>
                              <td style=" text-align:center;" ><?php echo ($yfa + $sadda231) ;?></td>
                              <td style=" text-align:center;" >0</td>
                         ...
                         <tr>
                              <td style=" text-align:center;" ></td>
                              <td style=" text-align:center;" ><?php echo ($yfa +$sadda23 + $sadda231) ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"><?php echo $sadda23 ;?></td>
                              <td style=" text-align:center;"> دخل خدمات التوزين  </td>
                              <td style=" text-align:center;">2 </td>
                        </tr>
                        <tr>
                              <td style=" text-align:center;" >الكمية المباعة : <?php echo $sadda24 ;?> كيلو</td>
                              <td style=" text-align:center;" ><?php echo ($yfa +$sadda23 + $sadda22 + $sadda231) ;?></td>
                              <td style=" text-align:center;" >0</td>
                        ...
                        <tr>
                              ...
                              <td style=" text-align:center;" ><?php echo ($yfa +$sadda23 + $sadda22 + $sadda231 - $sadda26) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda26 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> تكاليف شراء الحديد  </td>
                              <td style=" text-align:center;">4 </td>
                        </tr>
                        
                         <tr>
                              <td style=" text-align:center;" > التكاليف التشغلية</td>
                              <td style=" text-align:center;" ><?php echo ($yfa +$sadda23 + $sadda22 + $sadda231 - $sadda26 - $sadda27) ;?></td>
                         ...
                         <tr>
                              <td style=" text-align:center;" > </td>
                              <td style=" text-align:center;" ><?php echo ($yfa +$sadda23 + $sadda22 + $sadda231 - $sadda26 - $sadda27 - $sadda28) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda28 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> تسليفات الموظفين  </td>
                              <td style=" text-align:center;">6 </td>
                        </tr>
                        
                         <tr>
                              <td style=" text-align:center;" > رواتب الموظفين </td>
                              <td style=" text-align:center;" ><?php echo ($yfa +$sadda23 + $sadda22 + $sadda231 - $sadda26 - $sadda27 - $sadda28- $sadda29) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda29 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> الرواتب  </td>
                              <td style=" text-align:center;">6 </td>
                        </tr>
                    ...
                    <tbody id="output1" style="width: 100%;">
                       ...
                       <div style="float: right; padding-right: 20px; font-size: large;">  04/02/2022 - 29/01/2022 : التاريخ</div>
