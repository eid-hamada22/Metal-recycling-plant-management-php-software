...
<?php ob_start(); ?>
    <body id="body-pd">
            ...
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="batteries_entrance.php" class="nav__link active">
        ...
        <h1  class="mstera">مشتريات الطاريات</h1>
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="float: right;">: السائق</div>
                                    <div class="form-group">
                                        <input type="text" dir="rtl" placeholder="سائق الشاحنة"  class="form-control" name="drvr"  style="float: right;">
                                    </div>
                ...
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    <thead>
                        <tr>
                          ...
                          <th style="width: 20%;"><center>السائق</center></th>
                              ...
                              include 'includes/conn.php';
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        <td style=" text-align:center; width: 20%;">'.$row['driver'].'</td>
...
if (isset($_POST['add'])) {
    ...
    $sql ="INSERT INTO `batteries_entrance`(`date`, `driver`, `quantity`, `notes`) VALUES ('$datea','$drvr','$quantity','$notes')";

    if ($conn->query($sql)) { 

        header('location:batteries_entrance.php ');
    }
    }
