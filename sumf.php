...
ob_start(); 
    include 'includes/conn.php';
        ...
        if($_GET['iron'] == "1"){
        $sql123578 = "SELECT SUM(amount) as amount FROM  expenses WHERE date LIKE '%$dt%' ";
        }
        if($_GET['iron'] == "0"){
        $sql123578 = "SELECT SUM(amount) as amount FROM  expenses WHERE account != 'شراء حديد' and date LIKE '%$dt%' ";
...
?>
    <body id="body-pd">
        ...
        <h1 class="mstera ds">المصروفات : <?php echo $sadda2 ?>ش</h1>

        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"class="ds"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية صرف جديدة</button></div>
                        <center>
                    <form  method="post">
                <div class="input-group mb-3 ds"style="width: 50%;margin-top: 100px;position: absolute;">
                  <button class="btn btn-outline-secondary"name="dt" id="button-addon1">تصفية</button>
                  <input type="date" class="form-control"name="dataas" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1"value="<?php echo $_GET['date'];?>">
                </div>
                <div class="form-check form-switch ds"style="width: ;margin-top: 100px;position: absolute;margin-left: 51%;">
                    
                                        <button type="submit" class="btn btn-primary ds" name="<?php if($_GET['iron'] == 1){ echo"chak"; } else if($_GET['iron'] == 0) {echo"chak2";} ?>"><?php if($_GET['iron'] == 1){ echo"إخفاء"; } else if($_GET['iron'] == 0) {echo"إظهار";} ?> مشتريات الحديد</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" dir="rtl" placeholder="المبلغ المصروف" required class="form-control" name="amount"  style="float: right;">
                                    </div>
                                    ...
                                    <?php
                                            ...
                                            $sql1 = "SELECT * FROM accountes ORDER BY id DESC";
                                    ...
                                    <div class="form-group">
                                        <input type="datetime-local"required dir="rtl" class="form-control" name="date"  style="float: right;">
                                    </div>
                ...
                <table class="table table-hover tp" style="">
                    ...
                    <tbody id="output1" style="width: 100%;">
                            <?php
                              ...
                              $sql123578 = "SELECT SUM(quantity) as quantity FROM  fuel_entr  ";
                                $result123578 = mysqli_query($conn, $sql123578);
                                $row123578=mysqli_fetch_assoc($result123578);
                                $sadda2 = $row123578['quantity'];
                                
                                
                            $sql1235784 = "SELECT SUM(quantity) as quantity FROM  fuel WHERE account = 'الماتور'";
                                $result1235784 = mysqli_query($conn, $sql1235784);
                                $row1235784=mysqli_fetch_assoc($result1235784);
                                $sadda24 = $row1235784['quantity'];
                                                                
                            $sql1235785 = "SELECT SUM(quantity) as quantity FROM  fuel WHERE account = 'الباقر'";
                                $result1235785 = mysqli_query($conn, $sql1235785);
                                $row1235785=mysqli_fetch_assoc($result1235785);
                                $sadda25 = $row1235785['quantity'];
                                                                
                            $sql1235786 = "SELECT SUM(quantity) as quantity FROM  fuel WHERE account = 'المزليق'";
                                $result1235786 = mysqli_query($conn, $sql1235786);
                                $row1235786=mysqli_fetch_assoc($result1235786);
                                $sadda26 = $row1235786['quantity'];
                                                                
                            $sql1235787 = "SELECT SUM(quantity) as quantity FROM  fuel WHERE account = 'السيارة التارجيت'";
                                $result1235787 = mysqli_query($conn, $sql1235787);
                                $row1235787=mysqli_fetch_assoc($result1235787);
                                $sadda27 = $row1235787['quantity'];
                                                                
                            $sql1235788 = "SELECT SUM(quantity) as quantity FROM  fuel WHERE account = 'الماتور'";
                                $result1235788 = mysqli_query($conn, $sql1235788);
                                $row1235788=mysqli_fetch_assoc($result1235788);
                                $sadda28 = $row1235788['quantity'];
                                                                
                            $sql1235789 = "SELECT SUM(quantity) as quantity FROM  fuel WHERE account = 'الماتور'";
                                $result1235789 = mysqli_query($conn, $sql1235789);
                                $row1235789=mysqli_fetch_assoc($result1235789);
                                $sadda29 = $row1235789['quantity'];
                         ...
                         <tr>
                              ...
                              <td style=" text-align:center;" ><?php echo $sadda2 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"><?php echo $sadda2 ;?></td>
                              <td style=" text-align:center;"> الكمية الأولية </td>
                        ...
                        <tr>
                              <td style=" text-align:center;" ></td>
                              <td style=" text-align:center;" ><?php echo ($sadda2 -$sadda24) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda24 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> سحب الماتور  </td>
                        ...
                        <tr>
                              <td style=" text-align:center;" ></td>
                              <td style=" text-align:center;" ><?php echo ($sadda2 -$sadda24 - $sadda25 ) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda25 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> سحب المازليق  </td>
                              <td style=" text-align:center;">3 </td>
                        </tr>
                                                
                        <tr>
                              <td style=" text-align:center;" ></td>
                              <td style=" text-align:center;" ><?php echo ($sadda2 -$sadda24 - $sadda25 - $sadda26) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda26 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> سحب الباقر  </td>
                              <td style=" text-align:center;">4 </td>
                        </tr>
                                                
                        <tr>
                              <td style=" text-align:center;" ></td>
                              <td style=" text-align:center;" ><?php echo ($sadda2 -$sadda24 - $sadda25 - $sadda26 - $sadda27) ;?></td>
                              <td style=" text-align:center;"><?php echo $sadda27 ;?></td>
                              <td style=" text-align:center;" >0</td>
                              <td style=" text-align:center;"> سحب التارجيت  </td>
                    ...
                    <thead>
                        <tr>
                          <th style="width: 35%;"><center>ملاحظات</center></th>
                          <th style="width: 20%;"><center>المتبقي</center></th>                            
                          <th style="width: 15%;"><center>كل الخارج</center></th>
                          <th style="width: 15%;"><center>كل الداخل</center></th>
                    ...
                    <tbody id="output1" style="width: 100%;">
                         <tr>
                              <td style=" text-align:center;" > الزائد عن الرصيد</td>
                              <td style=" text-align:center;" ><?php echo ($sadda2 -$sadda24 - $sadda25 - $sadda26 - $sadda27) ;?></td>

                              <td style=" text-align:center;"><?php echo ($sadda24 + $sadda25 + $sadda26 + $sadda27)  ;?></td>
                                <td style=" text-align:center;"><?php echo ($sadda2)  ;?></td>
                       ...
                       <div style="float: right; padding-right: 20px; font-size: x-large;">  27/02/2022 - 22/02/2022 : التاريخ</div>
