        ...
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"class="ds"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية صرف جديدة</button></div>
            ...
            <button type="submit" class="btn btn-primary ds" name="prnt">طباعة</button>
                ...
                <table class="table table-hover tp" style="">
                    <thead>
                        <tr>
                          <th style="width: 30%;"><center>البيان</center></th>
                          <th style="width: 20%;"><center>التاريخ</center></th>
                          <th style="width: 25%;"><center>الجهة</center></th>
                          <th style="width: 10%;"><center> المبلغ</center></th>
                    ...
                    <?php
                             ...
                             if ($_GET['iron'] == "1") {
                                $sql = "SELECT * FROM expenses WHERE date LIKE '%$dt%'and date > '$farom'  ORDER BY id ";
                             }
                            if ($_GET['iron'] == "0") {
                                $sql = "SELECT * FROM expenses WHERE date LIKE '%$dt%' and date > '$farom' and account != 'شراء حديد' ORDER BY id ";
                             }
                             else{
                                $sql = "SELECT * FROM expenses WHERE date LIKE '%$dt%' and date > '$farom'  ORDER BY id ";
                             }
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        <td style=" text-align:center; width: %;" class="ds2">'.$datea.'</td>
                                        <td style=" text-align:center; width: %;" class="ds">'.$row['date'].'</td>
                                        <td style=" text-align:center; width: %;">'.$row['account'].'</td>
                ...
                <table class="table table-hover tp" style="">
                    ...
                    <?php
                        include 'includes/conn.php';
                            ...
                            $sql123578 = "SELECT SUM(amount) as amount FROM  expenses WHERE  date LIKE '%$dt%' and date > '$farom'";
                            $sql1235782 = "SELECT SUM(amount) as amount FROM  expenses WHERE account != 'شراء حديد' and date LIKE '%$dt%'and date > '$farom' ";
                            $sql1235783 = "SELECT SUM(amount) as amount FROM  expenses WHERE account = 'شراء حديد' and date LIKE '%$dt%' and date > '$farom'"; 
                            ...
                            $sadda2 = $row123578['amount'];
                    ?>
              <td style=" text-align:center;" class="tp3">تكاليف اخرى : <?php echo $sadda22; ?> شيكل </td>
              <td style=" text-align:center;">المجموع : <?php echo $sadda2; ?> شيكل </td>
                    ...
                    <table class="table table-hover tp tp3" style="">
                    ...
                    <?php
                        include 'includes/conn.php';
                            ...
                            if($_GET['iron'] == "1"){
                            $sql123578 = "SELECT SUM(quantity) as amount FROM  iron_smlentrance WHERE date LIKE '%$dt%' and date > '$farom'";
                            }
                            if($_GET['iron'] == "0"){
                            $sql123578 = "SELECT SUM(quantity) as amount FROM  iron_smlentrance WHERE  date LIKE '%$dt%' and date > '$farom'";
                            ...
                            $sql123578 = "SELECT SUM(quantity) as quantity FROM  iron_smlentrance WHERE  date LIKE '%$dt%' and date > '$farom'";
                            $sql1235782 = "SELECT SUM(amount) as amount FROM  iron_smlentrance WHERE  date LIKE '%$dt%' and date > '$farom'";
                            ...
                            $sadda23 = ($sadda22 / $sadda2);
                    ?>

              <td style="width: 30%; text-align:center;">تكاليف الشراء : <?php echo $sadda22; ?> شيكل </td>
              <td style="width: 30%; text-align:center;">كامل التسعير : <?php echo number_format($sadda23, 4, '.', ''); ?> شيكل </td>
              <td style="width: 40%; text-align:center;">الكمية المشترية : <?php echo $sadda2; ?> كيلو </td>
                            </tr>
                        </tbody>
                  </table>
                       <div style="float: right; padding-right: 20px;">  27/02/2022 - 22/02/2022 : التاريخ</div>
    </body>
</html>
<?php
    if (isset($_POST['prnt'])) {
