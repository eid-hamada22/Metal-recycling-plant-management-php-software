...
<?php ob_start(); include 'includes/session.php';?>
    ...
    <div class="l-navbar " id="navbar">
        ...
        <h1 style="margin-left:880px ;  position: absolute;">الزبائن</h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة زبون جديد</button></div>
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="float: right;">: الفئة</div>
                                    <div class="form-group">
                                            <select name="type" id="" class="form-control" dir="rtl">
                                                <option value="1">بائع حديد</option>
                                                <option value="2">بائع بطريات</option>
                                                <option value="3">بائع حديد وبطاريات</option>
                                                <option value="4">مشتري حديد</option>
                                                <option value="5">مشتري بطاريات</option>
                                                <option value="6">مشتري حديد وبطاريات</option>
                                            </select>
                                    </div>

                                    <div style="float: right;">: الرصيد</div>
                                    <div class="form-group">
                                        <input type="number" dir="rtl" placeholder="رصيد الحساب" value="0" required class="form-control" name="amount" style="float: right;">
                                    </div>
                ...
                <div style="float: right;position: absolute; margin-left:1100px ; margin-top: 100px; font-size: x-large">:الزبائن</div>
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    <thead> 
                        <tr>
                          ...
                          <th style="width: 25%;"><center> الفئة</center></th>
                          <th style="width: 25%;"><center> الاسم</center></th>
                              ...
                              include 'includes/conn.php';
                                ...
                                if(mysqli_num_rows($result)>0){
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        if($row['type'] == 1){$ty = "بائع حديد";}if($row['type'] == 2){$ty = "بائع بطاريات";}if($row['type'] == 3){$ty = "بائع حديد وبطاريات";}if($row['type'] == 4){$ty = "مشتري حديد ";}if($row['type'] == 5){$ty = "مشتري بطاريات";}if($row['type'] == 6){$ty = "مشتري حديد وبطاريات";}
                                        echo '
                                    	<tr dir="rtl" onclick="window.location='."'".'customer_operations.php?id='.$row['name'].''."'".';"> 
                                        <td style=" text-align:center; width: 30%;">'.$row['notes'].'</td>
                                        <td style=" text-align:center; width: 25%;">'.$row['balance'].'</td>
                                        <td style=" text-align:center; width: 25%;">'.$ty.'</td>
