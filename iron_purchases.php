...
<?php ob_start();include 'includes/session.php'; ?>
    <body id="body-pd">
            ...
            <nav class="nav" id="nevvv">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="iron_purchases.php" class="nav__link active">
        ...
        <h1 class="mstera">مبيعات حديد</h1>
        <script src="https://unpkg.com/ionicons@5.1.2/dist/ionicons.js"></script>
        
        <div style="float: right;position: absolute; font-size: x-large; margin-top: 50px;"><button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#name">اضافة عملية بيع جديدة</button></div>
                <div class="modal fade" id="name"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form method="post">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">مبيعات الحديد</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number"step="0.01" dir="rtl"placeholder="سعر الكيلو الواحد"  class="form-control" name="pricing"  style="float: right;">
                                    </div>

                                    <div style="float: right;">: المبلغ</div>
                                    <div class="form-group">
                                        <input type="number" dir="rtl" placeholder="المبلغ المدفوع"  class="form-control" name="amount"  style="float: right;">
                                    </div>
                ...
                <table class="table table-hover" style="width: 100%; margin-top: 150px;">
                    ...
                    <?php
                              include 'includes/conn.php';
                                $sql = "SELECT * FROM iron_purchases WHERE date > '$farom' ORDER BY id DESC";
...
if (isset($_POST['add'])) {
    ...
    $sql ="INSERT INTO `iron_purchases`(`date`, `quantity`, `pricing`, `amount`, `notes`) VALUES ('$datea','$quantity','$pricing','$amount','$notes')";

    $sql2 ="INSERT INTO `income`(`date`, `account`, `amount`, `notes`) VALUES ('$datea','بيع حديد','$amount','$notes , دخل بيع حديد')";

    if ($conn->query($sql) && $conn->query($sql2)) { 

        header('location:iron_purchases.php ');
    }
    }
